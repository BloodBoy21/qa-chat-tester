...
# Forward any extra args to the child process (except json_file and batch_size/max_workers)
FORWARD_ARGS = {
...
def run_batch_subprocess(batch_index: int, batch_file: str) -> dict:
    ...
    cmd = [
        ...
        f"batch_size={BATCH_SIZE}",  # whole batch processed inside main.py
    ]
...
def main():
    ...
    tmp_dir = tempfile.mkdtemp(prefix="batch_runner_")
