...
async def run_analysis_agent_manual(
    run_id: str, context: str, user_id: str, model: str, account_id: str = None
):
    try:
        logger.info(
        ...
        res = await runner.from_text(json.dumps(messages, default=_json_serial))
        ...
        save_analysis(session_id=session_id, analysis=res, run_id=run_id, account_id=account_id)
